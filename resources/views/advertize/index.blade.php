...
<head>
	...
	<link rel="apple-touch-icon" sizes="57x57" href="{{ $env }}/img/favicon/apple-touch-icon-57x57.png">
	<link rel="apple-touch-icon" sizes="60x60" href="{{ $env }}/img/favicon/apple-touch-icon-60x60.png">
	<link rel="apple-touch-icon" sizes="72x72" href="{{ $env }}/img/favicon/apple-touch-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="76x76" href="{{ $env }}/img/favicon/apple-touch-icon-76x76.png">
	<link rel="apple-touch-icon" sizes="114x114" href="{{ $env }}/img/favicon/apple-touch-icon-114x114.png">
	<link rel="apple-touch-icon" sizes="120x120" href="{{ $env }}/img/favicon/apple-touch-icon-120x120.png">
	<link rel="apple-touch-icon" sizes="144x144" href="{{ $env }}/img/favicon/apple-touch-icon-144x144.png">
	<link rel="apple-touch-icon" sizes="152x152" href="{{ $env }}/img/favicon/apple-touch-icon-152x152.png">
	<link rel="apple-touch-icon" sizes="180x180" href="{{ $env }}/img/favicon/apple-touch-icon-180x180.png">
	<link rel="icon" type="image/png" href="{{ $env }}/img/favicon/favicon-32x32.png" sizes="32x32">
	<link rel="icon" type="image/png" href="{{ $env }}/img/favicon/favicon-194x194.png" sizes="194x194">
	<link rel="icon" type="image/png" href="{{ $env }}/img/favicon/favicon-96x96.png" sizes="96x96">
	<link rel="icon" type="image/png" href="{{ $env }}/img/favicon/android-chrome-192x192.png" sizes="192x192">
	<link rel="icon" type="image/png" href="{{ $env }}/img/favicon/favicon-16x16.png" sizes="16x16">
	<link rel="manifest" href="{{ $env }}/img/favicon/manifest.json">
	<link rel="mask-icon" href="{{ $env }}/img/favicon/safari-pinned-tab.svg" color="#5bbad5">
	<link rel="shortcut icon" href="{{ $env }}/img/favicon/favicon.ico">
	<meta name="msapplication-TileColor" content="#66e0e5">
	<meta name="msapplication-TileImage" content="img/favicon/mstile-144x144.png">
	<meta name="msapplication-config" content="img/favicon/browserconfig.xml">
	<meta name="theme-color" content="#ffffff">
	<!-- end favicon links -->
	<link rel="stylesheet" href="{{ $env }}/css/bootstrap.min.css" />
	<link rel="stylesheet" href="{{ $env }}/css/normalize.min.css">
	<link rel="stylesheet" href="{{ $env }}/css/animate.min.css">
	<link rel="stylesheet" href="{{ $env }}/css/flickity.min.css">
	<link rel="stylesheet" href="{{ $env }}/css/styles.css">
...
<body>
	...
	<header class="hero">
		<div class="carousel js-flickity">
			<div class="carousel-cell" style="background-image: url({{ $env }}/img/hero-bg-01.jpg);">
				<div class="hero-bg">
					<div class="container">
						<div class="row">
			...
			<div class="carousel-cell" style="background-image: url({{ $env }}/img/hero-bg-02.jpg);">
				<div class="hero-bg">
					<div class="container">
						<div class="row">
							<div class="col-md-12 text-center">
			...
			<div class="carousel-cell" style="background-image: url({{ $env }}/img/hero-bg-03.jpg);">
				<div class="hero-bg">
					<div class="container">
						<div class="row">
							<div class="col-md-12 text-center">
			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="video-player">
						<video id="video_synth" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="auto" width="568" height="300" poster="{{ $env }}/img/video-cover.jpg" data-setup='{}'>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url({{ $env }}/img/article-01.jpg)">
				...
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url({{ $env }}/img/article-02.jpg)">
							</div>
							<figure>
								<figcaption>
				...
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url({{ $env }}/img/article-03.jpg)">
							</div>
							<figure>
								<figcaption>
			...
			<div class="row has-top-margin">
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url({{ $env }}/img/article-04.jpg)">
							</div>
							<figure>
								<figcaption>
				...
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url({{ $env }}/img/article-05.jpg)">
							</div>
							<figure>
								<figcaption>
				...
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url({{ $env }}/img/article-06.jpg)">
							</div>
							<figure>
								<figcaption>
				...
				<div class="col-md-6 no-padding">
					<article class="item wp5">
						<figure class="has-overlay">
							...
							<img src="{{ $env }}/img/sedna-freebie.jpg" alt="Sedna Freebie Peter Finlan">
						</figure>
					</article>
				</div>
				<div class="col-md-6 no-padding">
					<article class="item wp6">
						<figure class="has-overlay">
							...
							<img src="{{ $env }}/img/landio-freebie.jpg" alt="Land.io Freebie Peter Finlan">
						</figure>
					</article>
				</div>
			</div>
				...
				<div class="col-md-6 no-padding">
					<article class="item wp7">
						<figure class="has-overlay">
							...
							<img src="{{ $env }}/img/freebie-03.jpg" alt="Synthetica Freebie by Peter Finlan">
						</figure>
					</article>
				</div>
				<div class="col-md-6 no-padding">
					<article class="item wp8">
						<figure class="has-overlay">
							...
							<img src="{{ $env }}/img/freebie-04.jpg" alt="Synthetica by Freebie Peter Finlan">
						</figure>
					</article>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 footer-branding">
					<img class="footer-branding-logo" src="{{ $env }}/img/synthetica-logo.png" alt="Synthetica freebie html5 css3 template peter finlan logo">
	...
	<!-- JS Locals -->
	<script src="{{ $env }}/js/min/bootstrap.min.js"></script>
	<script src="{{ $env }}/js/min/modernizr-2.8.3-respond-1.4.2.min.js"></script>
	<script src="{{ $env }}/js/min/retina.min.js"></script>
	<script src="{{ $env }}/js/min/jquery.waypoints.min.js"></script>
	<script src="{{ $env }}/js/min/flickity.pkgd.min.js"></script>
	<script src="{{ $env }}/js/min/scripts-min.js"></script>
