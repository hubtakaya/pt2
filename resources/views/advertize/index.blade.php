...
<head>
	...
	<link rel="apple-touch-icon" sizes="57x57" href="http://suisen-book.com/advertize_design/img/favicon/apple-touch-icon-57x57.png">
	<link rel="apple-touch-icon" sizes="60x60" href="http://suisen-book.com/advertize_design/img/favicon/apple-touch-icon-60x60.png">
	<link rel="apple-touch-icon" sizes="72x72" href="http://suisen-book.com/advertize_design/img/favicon/apple-touch-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="76x76" href="http://suisen-book.com/advertize_design/img/favicon/apple-touch-icon-76x76.png">
	<link rel="apple-touch-icon" sizes="114x114" href="http://suisen-book.com/advertize_design/img/favicon/apple-touch-icon-114x114.png">
	<link rel="apple-touch-icon" sizes="120x120" href="http://suisen-book.com/advertize_design/img/favicon/apple-touch-icon-120x120.png">
	<link rel="apple-touch-icon" sizes="144x144" href="http://suisen-book.com/advertize_design/img/favicon/apple-touch-icon-144x144.png">
	<link rel="apple-touch-icon" sizes="152x152" href="http://suisen-book.com/advertize_design/img/favicon/apple-touch-icon-152x152.png">
	<link rel="apple-touch-icon" sizes="180x180" href="http://suisen-book.com/advertize_design/img/favicon/apple-touch-icon-180x180.png">
	<link rel="icon" type="image/png" href="http://suisen-book.com/advertize_design/img/favicon/favicon-32x32.png" sizes="32x32">
	<link rel="icon" type="image/png" href="http://suisen-book.com/advertize_design/img/favicon/favicon-194x194.png" sizes="194x194">
	<link rel="icon" type="image/png" href="http://suisen-book.com/advertize_design/img/favicon/favicon-96x96.png" sizes="96x96">
	<link rel="icon" type="image/png" href="http://suisen-book.com/advertize_design/img/favicon/android-chrome-192x192.png" sizes="192x192">
	<link rel="icon" type="image/png" href="http://suisen-book.com/advertize_design/img/favicon/favicon-16x16.png" sizes="16x16">
	<link rel="manifest" href="http://suisen-book.com/advertize_design/img/favicon/manifest.json">
	<link rel="mask-icon" href="http://suisen-book.com/advertize_design/img/favicon/safari-pinned-tab.svg" color="#5bbad5">
	<link rel="shortcut icon" href="http://suisen-book.com/advertize_design/img/favicon/favicon.ico">
	...
	<link rel="stylesheet" href="http://suisen-book.com/advertize_design/css/styles.css">
...
<body>
	...
	<!-- JS Locals -->
	<script src="http://suisen-book.com/advertize_design/js/min/bootstrap.min.js"></script>
	<script src="http://suisen-book.com/advertize_design/js/min/modernizr-2.8.3-respond-1.4.2.min.js"></script>
	<script src="http://suisen-book.com/advertize_design/js/min/retina.min.js"></script>
	<script src="http://suisen-book.com/advertize_design/js/min/jquery.waypoints.min.js"></script>
	<script src="http://suisen-book.com/advertize_design/js/min/flickity.pkgd.min.js"></script>
	<script src="http://suisen-book.com/advertize_design/js/min/scripts-min.js"></script>
